...
BEGIN
    CREATE TABLE Tasks (
        Id INT IDENTITY(1,1) PRIMARY KEY,
        ProjectId INT NULL FOREIGN KEY REFERENCES Projects(Id) ON DELETE SET NULL,
        MilestoneId INT NULL FOREIGN KEY REFERENCES Milestones(Id) ON DELETE SET NULL,
        TeamId INT NULL FOREIGN KEY REFERENCES Teams(Id) ON DELETE SET NULL,
        AssignedToUserId INT NULL FOREIGN KEY REFERENCES Users(Id) ON DELETE SET NULL,
        Title NVARCHAR(200) NOT NULL,
